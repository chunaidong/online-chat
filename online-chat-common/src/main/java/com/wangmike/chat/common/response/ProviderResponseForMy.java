...
public class ProviderResponseForMy
    ...
    public int getProviderLevel() {
        return providerLevel;
    }

    public void setProviderLevel(int providerLevel) {
        this.providerLevel = providerLevel;
    }

    /*  78 */
    public String getProviderWechatNo() {
        return this.providerWechatNo;
    }


    /*  82 */
    public void setProviderWechatNo(String providerWechatNo) {
        this.providerWechatNo = providerWechatNo;
    }


    /*  86 */
    public List<ProviderType> getTypeList() {
        return this.typeList;
    }


    /*  90 */
    public void setTypeList(List<ProviderType> typeList) {
    ...
    /* 110 */
    public Integer getProviderAge() {
        return this.providerAge;
    }


    /* 114 */
    public void setProviderAge(Integer providerAge) {
    ...
    /* 142 */
    public Date getProviderBirthDay() {
        return this.providerBirthDay;
    }


    /* 146 */
    public void setProviderBirthDay(Date providerBirthDay) {
    ...
    public String getProviderEmotionName() {
        return this.providerEmotionName;
    }
    ...
    /* 167 */
    public List<String> getHeadsLists() {
        return this.headsLists;
    }


    /* 171 */
    public void setHeadsLists(List<String> headsLists) {
        this.headsLists = headsLists;
    }


    /* 175 */
    public String getProviderRawWechatNo() {
        return this.providerRawWechatNo;
    }


    /* 179 */
    public String getProviderRawContent() {
        return this.providerRawContent;
    }


    /* 183 */
    public void setProviderRawContent(String providerRawContent) {
        this.providerRawContent = providerRawContent;
    }


    /* 187 */
    public void setProviderRawWechatNo(String providerRawWechatNo) {
        this.providerRawWechatNo = providerRawWechatNo;
    }
}
